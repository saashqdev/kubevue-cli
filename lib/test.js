...
const selectorPath = require.resolve('@kubevue/vue-loader/lib/selector');
...
/**
 * kubevue test will run files ending with .spec.js in the src or test directory by default.
 * or *.vue contains the test code under the test tag
 * Only process vue files containing the test tag (otherwise webpack will report a lot of warnings)
 */
