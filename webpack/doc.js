...
const webpackConfig = merge(baseConfig, {
    entry: {
        docs: require.resolve('@kubevue/doc-loader/views/index.js'),
    },
    output: {
...
// webpackConfig.module.rules.push({ test: /\.vue[\\/]index\.js$/, loader: '@kubevue/doc-loader' }); // Position below so processing before `vue-multifile-loader`
...
if (!config.theme) {
    webpackConfig.plugins.push(new HTMLWebpackPlugin({
        filename: 'index.html',
        template: path.resolve(require.resolve('@kubevue/doc-loader/views/index.js'), '../index.html'),
        chunks: ['docs'],
        hash: true,
    }));
    ...
    webpackConfig.plugins.push(new HTMLWebpackPlugin({
        filename: 'index.html',
        template: path.resolve(require.resolve('@kubevue/doc-loader/views/index.js'), '../theme.html'),
        chunks: ['docs'],
        inject: false,
    }));
    // For history mode 404 on GitHub
